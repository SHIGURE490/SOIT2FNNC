...
% line([1,1],[-0.6,0.4],'linestyle','--','linewidth',2.5,'color','k')
...
% line([1,1],[-0.2,0.8],'linestyle','--','linewidth',2.5,'color','k')
% % 创建 ylabel
% ylim=[-0.1 0.7];
...
%     'LineWidth',1,'YLim',[-0.001 0.001]);
% hold on;
% e11=plot(time(750:2750), error_SOIT2FNN(1,750:2750),'color','#D95319','linewidth', 2.5);
% e12=plot(time(750:2750), error_pid(1,750:2750),'color','#7E2F8E','linewidth', 2.5);
% e13=plot(time(750:2750), -error_PFTSMC(1,750:2750),'color','#0072BD','linewidth', 2.5);
% e14=plot(time(750:2750), -error_AFFTFTSMC(1,750:2750),'color','#EDB120','linewidth', 2.5);
% e15=plot(time(750:2750), error_NNFTFTSMC(1,750:2750),'color','#4DBEEE','linewidth', 2.5);
% line([1,1],[-0.001,0.001],'linestyle','--','linewidth',2.5,'color','k');
% 
% axes5=axes('Position',[0.22 0.29 0.075 0.1]);
% set(axes5,'FontName','Times New Roman','FontSize',20,...
%     'LineWidth',1,'YLim',[-0.005 0.005]);
% hold on;
...
%     'LineWidth',1,'YLim',[-0.0005 0.0005]);
% hold on;
% e11=plot(time(750:2750), error_SOIT2FNN(2,750:2750),'color','#D95319','linewidth', 2.5);
% e12=plot(time(750:2750), error_pid(2,750:2750),'color','#7E2F8E','linewidth', 2.5);
% e13=plot(time(750:2750), -error_PFTSMC(2,750:2750),'color','#0072BD','linewidth', 2.5);
% e14=plot(time(750:2750), -error_AFFTFTSMC(2,750:2750),'color','#EDB120','linewidth', 2.5);
% e15=plot(time(750:2750), error_NNFTFTSMC(2,750:2750),'color','#4DBEEE','linewidth', 2.5);
% line([1,1],[-0.001,0.001],'linestyle','--','linewidth',2.5,'color','k');
% 
...
%     'LineWidth',1,'YLim',[-0.0005 0.0005]);
% hold on;
% e11=plot(time(750:2750), error_SOIT2FNN(3,750:2750),'color','#D95319','linewidth', 2.5);
% e12=plot(time(750:2750), error_pid(3,750:2750),'color','#7E2F8E','linewidth', 2.5);
% e13=plot(time(750:2750), -error_PFTSMC(3,750:2750),'color','#0072BD','linewidth', 2.5);
% e14=plot(time(750:2750), -error_AFFTFTSMC(3,750:2750),'color','#EDB120','linewidth', 2.5);
% e15=plot(time(750:2750), error_NNFTFTSMC(3,750:2750),'color','#4DBEEE','linewidth', 2.5);
% line([1,1],[-0.001,0.001],'linestyle','--','linewidth',2.5,'color','k');
% 
...
set(axes2,'FontName','Times New Roman','FontSize',28,...
    'LineWidth',1,'YLim',[-400,400]);
%画误差3
axes3 = subplot('Position',[0.74 0.25 0.25 0.4]);
hold on;
grid on;
...
axes5=axes('Position',[0.12 0.29 0.075 0.1]);
set(axes5,'FontName','Times New Roman','FontSize',20,...
    'LineWidth',1,'YLim',[-50 50]);
hold on;
e11=plot(time(500:1500), u_c(1,500:1500),'color','#D95319','linewidth', 2.5);
e12=plot(time(500:1500), u_n(1,500:1500),'color','#7E2F8E','linewidth', 2.5);
line([0.5,0.5],[-400,400],'linestyle','--','linewidth',2.5,'color','k');

axes5=axes('Position',[0.455 0.29 0.075 0.1]);
set(axes5,'FontName','Times New Roman','FontSize',20,...
    'LineWidth',1,'YLim',[-50 50]);
hold on;
e11=plot(time(500:1500), u_c(2,500:1500),'color','#D95319','linewidth', 2.5);
e12=plot(time(500:1500), u_n(2,500:1500),'color','#7E2F8E','linewidth', 2.5);
line([0.5,0.5],[-400,400],'linestyle','--','linewidth',2.5,'color','k');

axes5=axes('Position',[0.78 0.29 0.075 0.1]);
set(axes5,'FontName','Times New Roman','FontSize',20,...
    'LineWidth',1,'YLim',[-50 50]);
hold on;
e11=plot(time(500:1500), u_c(3,500:1500),'color','#D95319','linewidth', 2.5);
e12=plot(time(500:1500), u_n(3,500:1500),'color','#7E2F8E','linewidth', 2.5);
line([0.5,0.5],[-400,400],'linestyle','--','linewidth',2.5,'color','k');
